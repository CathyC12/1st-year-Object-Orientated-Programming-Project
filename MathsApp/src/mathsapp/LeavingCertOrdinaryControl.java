 ...
 * @author x13335131
 */
public class LeavingCertOrdinaryControl {
     public static String correctAnswers[]=new String[10];//what answer should be
    public static String answers[]=new String[10];//user input/answer
    public static boolean correct[]= new boolean[10];//corrects whether its right or wrong
    public static int count=0;
    
    //populates arrays
    public static void populate () {
        correctAnswers[0]="€1250";
        correctAnswers[1]="negative";
        correctAnswers[2]="0.08";
        correctAnswers[3]="-5";
        correctAnswers[4]="7";
        correctAnswers[5]="240";
        correctAnswers[6]="0.45";
        correctAnswers[7]="0.87";
        correctAnswers[8]="10";
        correctAnswers[9]="11mm";
    ...
    public static void validateQuestion8(){
     ...
     //summary at the end of quiz, prints out score and shows user which questions they got wrong
      ...
      result = "Leaving Cert Ordinary Quiz - "+count+"%";
      saveResults(result);
      return summary;
    }
    ...
    return count;
      ...
      //makes a .txt file to store previous results

 ...
 * @author x13335131
 */
public class JuniorCertHigherControl {
     public static String correctAnswers[]=new String[10];//what answer should be
    public static String answers[]=new String[10];//what user enters
    ...
    public static void populate () {
        correctAnswers[0]="35%";
        correctAnswers[1]="d";
        correctAnswers[2]="{2,4,6}";
        correctAnswers[3]="(3a-2b)(3a+4c)";
        correctAnswers[4]="€31827";
        correctAnswers[5]="100";
        correctAnswers[6]="3.5";
        correctAnswers[7]="13m";
        correctAnswers[8]="1.4";
        correctAnswers[9]="1:8";
    ...
    public static void validateQuestion8(){
     ...
     //summary at the end of quiz, prints out score and shows user which questions they got wrong
      ...
      result = "Junior Cert Higher Quiz - "+count+"%";
      saveResults(result);
      return summary;
    }
